...
extern NSInteger const STResponseCancelError;
...
@interface STRequestManagerConfiguration : NSObject <NSCopying>
/**
 ...
 */
@property (nonatomic, copy) void (^responseHandler)(AFHTTPRequestOperation *operation, id userInfo, STResponse *response, BOOL *shouldStopProcessing);
...
typedef void (^STRequestManagerConfigurationHandler)(STRequestManagerConfiguration *configuration);

typedef void (^STRequestManagerCompletionHandler)(NSError *error, id result, BOOL isFromCache, AFHTTPRequestOperation *operation);

typedef void (^STRequestManagerParametersHandler)(NSMutableDictionary *requestParameters, NSMutableDictionary *builtinParameters);
 ...
 */
@property(nonatomic) STRequestManagerConfiguration *configuration;
 ...
 */
@property (nonatomic, copy) STRequestManagerParametersHandler parametersHandler;
